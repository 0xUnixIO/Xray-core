...
const file_transport_internet_finalmask_header_custom_config_proto_rawDesc = "" +
	...
	"\x04mode\x18\x03 \x01(\tR\x04modeB\xb3\x01\n" +
	"3com.xray.transport.internet.finalmask.header.customP\x01ZHgithub.com/0xUnixIO/Xray-core/transport/internet/finalmask/header/custom\xaa\x02/Xray.Transport.Internet.Finalmask.Header.Customb\x06proto3"

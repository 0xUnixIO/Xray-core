...
const file_transport_internet_finalmask_header_dtls_config_proto_rawDesc = "" +
	...
	"\x06ConfigB\xac\x01\n" +
	"1com.xray.transport.internet.finalmask.header.dtlsP\x01ZEgithub.com/0xUnixIO/Xray-core/transport/internet/finalmask/header/dtls\xaa\x02-Xray.Transport.Internet.Finalmask.Header.Dtlsb\x06proto3"

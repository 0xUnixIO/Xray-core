...
const file_app_policy_config_proto_rawDesc = "" +
	...
	"\x05value\x18\x02 \x01(\v2\x17.xray.app.policy.PolicyR\x05value:\x028\x01BS\n" +
	"\x13com.xray.app.policyP\x01Z(github.com/0xUnixIO/Xray-core/app/policy\xaa\x02\x0fXray.App.Policyb\x06proto3"

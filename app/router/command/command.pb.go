...
import (
	net "github.com/0xUnixIO/Xray-core/common/net"
	serial "github.com/0xUnixIO/Xray-core/common/serial"
...
const file_app_router_command_command_proto_rawDesc = "" +
	...
	"\bListRule\x12(.xray.app.router.command.ListRuleRequest\x1a).xray.app.router.command.ListRuleResponse\"\x00Bk\n" +
	"\x1bcom.xray.app.router.commandP\x01Z0github.com/0xUnixIO/Xray-core/app/router/command\xaa\x02\x17Xray.App.Router.Commandb\x06proto3"
